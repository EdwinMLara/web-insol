  ...
  return (
    <div className=" flex justify-center items-center h-screen ">
      ...
      <div className="bg-gradient-to-b from-secondary to-tertiary p-8 rounded shadow-md w-[56rem]">
        ...
        <h1 className="font-bold text-2xl text-white">Agregar Nueva Categoria </h1>
        </div>
        <form>
          <div className="mb-4">
          ...
          <div class="grid grid-cols-2 gap-6">
            ...
            <div className="mb-4">
            <label for="descripcion" className="block text-sm font-medium ">
                Descipcion
              </label>
              <textarea
              id="descripcion"
              name="descripcion"
              className="mt-1 p-2 w-full border rounded-md"
              placeholder="Informacion de la Categioria "
            ></textarea> 
            </div>
          </div>
          <div className="mb-4">
