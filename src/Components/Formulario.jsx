...
function Formulario() {
  return (
    <div className="flex bg-gradient-to-r from-blue-500 via-blue-950 to-black absolute left-0 right-0">
      <div className="w-1/2 p-8 ">
        <h1 className="text-4xl font-bold mb-4 text-white text-left pt-32">
          AUTOMATIZACION <br />
          REDEFINIDA <br />
          <h2 className="pl-24 text-3xl">Contactanos.</h2>
        </h1>
      </div>
  ...
  <option disabled selected value="Servicio">Servicios</option>
