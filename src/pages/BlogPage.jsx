  ...
  const noticias = [
    {
      ...
      descripcion: "Desbloqueando el Potencial Empresarial: Las Ventajas Estratégicas de la Automatización en Tu Negocio",
      imagen: Automa
    ...
    },
    {
      id: 2,
      titulo: "Vitalidad",
      descripcion: "Maximiza tus Oportunidades: Los Beneficios Estratégicos de un Punto de Venta en tu Negocio",
      imagen: Puntoven
    ...
    },
    {
      id: 3,
      titulo: "Esenciales",
      descripcion: "Las 10 Herramientas Esenciales para el Hogar: ¡Imprescindibles para Cualquier Proyecto!",
      imagen: Herra
      //enlace: "https://ejemplo.com/noticia2"
    },
    {
      id: 4,
      titulo: "Presencia",
      descripcion: "Construyendo tu Presencia en Línea: La Crítica Importancia de una Página Web para Empresas",
      imagen: Web
      //enlace: "https://ejemplo.com/noticia2"
    },
